...
import CategeryList from "../Components/Categery";
import DistanceList from "../Components/Distance";
...
//lession
import Lession1List from "../Components/Lession1";
import Lession2List from "../Components/Lession2";
import Lession3List from "../Components/Lession3";
import Lession4List from "../Components/Lession4";
import Lession5List from "../Components/Lession5";
import Lession6List from "../Components/Lession6";
import Lession7List from "../Components/Lession7";
import Lession8List from "../Components/Lession8";
import Lession9List from "../Components/Lession9";
import Lession10List from "../Components/Lession10";
...
import AllAlzheimer from "../Components/AllAlzheimer";
...
import AlzheimerCategory from "../Components/Alzimer/assessment-category";
// //Job Search
...
import AlzheimerQuestion from "../Components/AlzheimerQuestion";
// //Editor
...
import AllVendors from "../Components/Fitness/Vendor";
import DietChart from "../Components/Fitness/DietChart/DietChart";
// import HomeBanner from "../Components/HomeBanner";
import HomeBanners from "../Components/HomeBanners";
import FitnessBanners from "../Components/FitnessBanners";
import ExtraBanners from "../Components/ExtraBanners";
import VendorsCategory from "../Components/Fitness/Vendors Category";
import VideoCategory from "../Components/Fitness/Video Category";
import MemberList from "../Components/MemberList";
import EventList from "../Components/EventList";
import EventLists from "../Components/EventLists";
import Classes from "../Components/class";
import Videos from "../Components/video";
import SocailMeetCategory from "../Components/SocialMeet";
import AllSubAdmin from "../Components/subadmin";
import AllRoles from "../Components/subadmin/role";
import AllPermission from "../Components/subadmin/permission";
import UserPermission from "../Components/subadmin/assign/assignPermission";
import MedicineList from "../Components/medicalReminder/medicine";
import AssessmentCategoryTable from "../Components/Alzimer/assessment-category/AssessmentCategoryTable";
// import DoctorList from "../Components/medicalReminder/doctor";
import FitnessCategory from "../Components/Fitness/FitnessCategory";
import VacinationList from "../Components/medicalReminder/vacination";
import CommunityList from "../Components/medicalReminder/commuity";
import VendorChemistList from "../Components/Fitness/chemist";
// import Dashboards from "../Components/Dashboards";
import VideoList from "../Components/Alzimer/videos/VideoList"
import TaskList from "../Components/Alzimer/task/TaskList";
import ActivityList from "../Components/Alzimer/activity/ActivityList";
// import DoctorList from "../Components/medicalReminder/doctor";
import DoctorList from "../Components/Alzimer/doctor/DoctorList";
import BlockUser from "../Components/BlockUser";
import AlzheimerQuestions from "../Components/Alzimer/assessment";
import Story from "../Components/Story";
import Badges from "../Components/Badges";
import Experts from "../Components/Experts";
import ExpertDashboard from "../Components/ExpertDashboard";
import ExpertEvents from "../Components/ExpertEvents";
import ExpertLive from "../Components/ExpertLive";
import AdminProducts from "../Components/Products";
import OrderStatus from "../Components/OrderStatus";
import LegacyAutismGamesRedirect from "../Components/Games/LegacyAutismGamesRedirect";
export const adminRoutes = [
  ...
  //vendors
  { path: `${process.env.PUBLIC_URL}/allVendors/:layout?`, Component: <AllVendors /> },
  { path: `${process.env.PUBLIC_URL}/allClasses/:layout?`, Component: <Classes /> },
  { path: `${process.env.PUBLIC_URL}/allVideos/:layout?`, Component: <Videos /> },
  { path: `${process.env.PUBLIC_URL}/vender_category/:layout?`, Component: <FitnessCategory /> },
  { path: `${process.env.PUBLIC_URL}/chemist/:layout?`, Component: <VendorChemistList /> },


  // subAdmin
  {path:`${process.env.PUBLIC_URL}/allRole/:layout?`,Component:<AllRoles/>},
  {path:`${process.env.PUBLIC_URL}/subAdmin/:layout?`,Component:<AllSubAdmin/>},
  {path:`${process.env.PUBLIC_URL}/permission/:layout?`,Component:<AllPermission/>},
  {path:`${process.env.PUBLIC_URL}/assignPermission/:layout?`,Component:<UserPermission/>},

  // medical reminder
  {path:`${process.env.PUBLIC_URL}/medicine/:layout?`,Component:<MedicineList/>},
  {path:`${process.env.PUBLIC_URL}/doctor/:layout?`,Component:<DoctorList/>},
  {path:`${process.env.PUBLIC_URL}/vacination/:layout?`,Component:<VacinationList/>},
  {path:`${process.env.PUBLIC_URL}/community/:layout?`,Component:<CommunityList/>},
  {path:`${process.env.PUBLIC_URL}/event/:layout?`,Component:<EventList/>},
  {path:`${process.env.PUBLIC_URL}/categery/:layout?`,Component:<CategeryList/>},
  {path:`${process.env.PUBLIC_URL}/distance/:layout?`,Component:<DistanceList/>},

// Autism list
   {path:`${process.env.PUBLIC_URL}/Lession1/:layout?`,Component:<Lession1List/>},
   {path:`${process.env.PUBLIC_URL}/Lession2/:layout?`,Component:<Lession2List/>},
   {path:`${process.env.PUBLIC_URL}/Lession3/:layout?`,Component:<Lession3List/>},
   {path:`${process.env.PUBLIC_URL}/Lession4/:layout?`,Component:<Lession4List/>},
   {path:`${process.env.PUBLIC_URL}/Lession5/:layout?`,Component:<Lession5List/>},
   {path:`${process.env.PUBLIC_URL}/Lession6/:layout?`,Component:<Lession6List/>},
   {path:`${process.env.PUBLIC_URL}/Lession7/:layout?`,Component:<Lession7List/>},
   {path:`${process.env.PUBLIC_URL}/Lession8/:layout?`,Component:<Lession8List/>},
   {path:`${process.env.PUBLIC_URL}/Lession9/:layout?`,Component:<Lession9List/>},
   {path:`${process.env.PUBLIC_URL}/Lession10/:layout?`,Component:<Lession10List/>},
   
  // Alzheimer
  {path:`${process.env.PUBLIC_URL}/assessment/:layout?`,Component:<AlzheimerQuestions/>},
  {path:`${process.env.PUBLIC_URL}/assessment-category/:layout?`,Component:<AlzheimerCategory/>},
  {path:`${process.env.PUBLIC_URL}/videos/:layout?`,Component:<VideoList/>},
  {path:`${process.env.PUBLIC_URL}/meditation/:layout?`,Component:<VacinationList/>},
  {path:`${process.env.PUBLIC_URL}/task/:layout?`,Component:<TaskList/>},
  {path:`${process.env.PUBLIC_URL}/activities/:layout?`,Component:<ActivityList/>},
  {path:`${process.env.PUBLIC_URL}/doctors/:layout?`,Component:<DoctorList/>},
  {path:`${process.env.PUBLIC_URL}/doctors-category/:layout?`,Component:<CommunityList/>},
    {path:`${process.env.PUBLIC_URL}/Caregiver/:layout?`,Component:<Caregiver/>},
    {path:`${process.env.PUBLIC_URL}/Appointment/:layout?`,Component:<Appointment/>},

 
  // Category
  { path: `${process.env.PUBLIC_URL}/Vendors/VendorsCategory/:layout?`, Component: <VendorsCategory /> },
  { path: `${process.env.PUBLIC_URL}/Vendors/VideoCategory/:layout?`, Component: <VideoCategory /> },
  { path: `${process.env.PUBLIC_URL}/Donate/:layout?`, Component: <Donate /> },
    { path: `${process.env.PUBLIC_URL}/DonateCategory/:layout?`, Component: <DonateCategory /> },

  { path: `${process.env.PUBLIC_URL}/AllAlzheimer/:layout?`, Component: <AllAlzheimer /> },


  //DietChart
  { path: `${process.env.PUBLIC_URL}/diet_chart/:layout?`, Component: <DietChart /> },

  //users
  { path: `${process.env.PUBLIC_URL}/allUsers/:layout?`, Component: <AllUsers /> },
  { path: `${process.env.PUBLIC_URL}/experts/:layout?`, Component: <Experts /> },
  { path: `${process.env.PUBLIC_URL}/social-meet/member-list/:layout?`, Component: <MemberList/> },
  { path: `${process.env.PUBLIC_URL}/social-meet/event-list/:layout?`, Component: <EventLists/> },
  { path: `${process.env.PUBLIC_URL}/social-meet/Category/:layout?`, Component: <SocailMeetCategory/> },
  { path: `${process.env.PUBLIC_URL}/blockUser/:layout?`, Component: <BlockUser /> },
  { path: `${process.env.PUBLIC_URL}/AlzheimerCategory/:layout?`, Component: <AssessmentCategoryTable /> },
  { path: `${process.env.PUBLIC_URL}/AlzheimerQuestion/:layout?`, Component: <AlzheimerQuestion /> },

  // banner
  { path: `${process.env.PUBLIC_URL}/banner/home_banner/:layout?`, Component: <HomeBanners /> },
  { path: `${process.env.PUBLIC_URL}/banner/fitness_banner/:layout?`,  Component: <FitnessBanners />}, // <FitnessBanner/>
  { path: `${process.env.PUBLIC_URL}/banner/home_banner3/:layout?`,  Component: <ExtraBanners />}, // <HomeBanners3 />

  { path: `${process.env.PUBLIC_URL}/services/:layout?`, Component: <Services /> },
  { path: `${process.env.PUBLIC_URL}/services/category/:layout?`, Component: <ServiceCategory /> },
  { path: `${process.env.PUBLIC_URL}/products/:layout?`, Component: <AdminProducts /> },
  { path: `${process.env.PUBLIC_URL}/products/order-status/:layout?`, Component: <OrderStatus /> },

  { path: `${process.env.PUBLIC_URL}/autizm-game/:layout?`, Component: <Games /> },
  { path: `${process.env.PUBLIC_URL}/games/:layout?`, Component: <LegacyAutismGamesRedirect /> },
  { path: `${process.env.PUBLIC_URL}/alzheimer-games/:layout?`, Component: <Games /> },
  { path: `${process.env.PUBLIC_URL}/story/:layout?`, Component: <Story /> },
  { path: `${process.env.PUBLIC_URL}/badges/:layout?`, Component: <Badges /> },
...
export const expertRoutes = [
  { path: `${process.env.PUBLIC_URL}/expert/dashboard/:layout?`, Component: <ExpertDashboard /> },
  { path: `${process.env.PUBLIC_URL}/expert/my-events/:layout?`, Component: <ExpertEvents /> },
  { path: `${process.env.PUBLIC_URL}/expert/live/:eventId/:layout?`, Component: <ExpertLive /> },
  { path: `${process.env.PUBLIC_URL}/app/users/profile/:layout?`, Component: <UsersProfileContain /> },
];
